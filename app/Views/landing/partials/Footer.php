    ...
    <footer
      class="wow fadeInUp relative z-10 bg-black pt-4 lg:pt-[40px]"
      data-wow-delay=".15s"
    >
      <!-- <div class="container">
...
<script>
  ...
  window.onscroll = function () {
    ...
    if (ud_header.classList.contains("sticky")) {
      logo.src = "<?= base_url('/public/assets/images/logo-light.png'); ?>";
    } else {
      logo.src = "<?= base_url('/public/assets/images/logo-1.png'); ?>";
    }
