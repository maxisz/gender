     ...
     <?php $this->extend('/landing/partials/Header'); ?>
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              <div class="wow fadeInUp text-center" data-wow-delay=".3s">
                <img
                  src="<?= base_url('/public'); ?>/assets/images/code.png"
                  alt="image"
                  class="mx-auto w-full max-w-[170px] opacity-50 transition duration-300 ease-in-out hover:opacity-100"
                />
              </div>
            </div>
          </div>
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <!-- <img
                  src="<?= base_url('/public'); ?>/assets/images/hero/hero-image.jpg"
                  alt="hero"
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              Intergrating The api to your application is as easy as abcd and as fast as lightneing
              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
              upload your excel forms and get your form auto-filled and processed instantly
              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
              get names based on your country or the names country
              </p>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Our data server is up and running with a runtime of 99.9% to keep you and your intergrations online
              </p>
            ...
            <div class="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                  Gender APi helps you to improve the experience for your customers.
                  Create simpler forms. Optimize your websites and apps. With an easy to implement API.
                  </p>
                  <!-- <a
                ...
                <div class="text-center">
                  <div class="relative z-10 inline-block">
                    <img
                      src="<?= base_url('/public'); ?>//assets/images/hero/capture.png"
                      alt="image"
    ...
    <section
      id="about"
      class="bg-[#f3f4fe] pt-10 pb-10 lg:pt-[60px] lg:pb-[60px]"
    >
      <div class="test pt-10 pb-10">
      <div class="container">
      <h2 class="text-center" >Create search boxes</h2>
    ...
    <?= $this->include('/landing/partials/Pricing'); ?>
    <!-- ====== Pricing Section End -->
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Got Doubts about gender Api And its usage?
              </p>
            </div>
          </div>
        </div>
...
function test(){
    ...
    $.ajax({
        url: "<?= base_url(); ?>/api?name="+name+"&key=69efc92e4d59cc24",
        type: 'GET',
        dataType: false, // added data type
