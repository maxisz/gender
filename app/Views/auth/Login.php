          ...
          <div class="w-full px-4">
            ...
            >
              ...
              <p class="text-base text-[#adadad]">
                Not a member yet?
                <a href="<?= base_url('/auth/signup'); ?>" class="text-primary hover:underline">
                  Sign Up
                </a>
              </p>
          ...
          $.ajax({
            ...
            success: function (response) {
               if(response == "success")
               {
                ...
                //  swal("success","<?= session()->get('user_name');?>","success")
                 setTimeout(() => {
