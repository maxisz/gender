        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                    <img src="<?= base_url('/public/assets/images/logo-sm.png'); ?>" alt="" height="48">
                    </span>
                    <span class="logo-lg">
                    <img src="<?= base_url('/public/assets/images/logo-light.png'); ?>" alt="" height="48"> <span class="logo-txt"></span>
                    </span>
                </a>

                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= base_url('/public/assets/images/logo-sm.png'); ?>" alt="" height="30">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="#!" class="small text-reset text-decoration-underline"> <?= lang('Files.Unread') ?> (2)</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="https://avatars.dicebear.com/api/avataaars/smilee.svg" alt="Header Avatar">
