...
// auth and landinf
$routes->get('/login', 'Auth::index',['filter' => 'Home']);
$routes->get('/signup', 'Auth::Signup',['filter' => 'Home']);
$routes->post('/contact', 'Functions::contact');
...
$routes->get('/admin/keys', 'Admin::keys',['filter' => 'Admin']);
$routes->get('/admin/plans', 'Admin::plans',['filter' => 'Admin']);
$routes->get('/admin/names', 'Admin::names',['filter' => 'Admin']);
$routes->get('/admin/settings', 'Admin::settings',['filter' => 'Admin']);
$routes->get('/admin/invoices', 'Admin::invoices',['filter' => 'Admin']);
$routes->get('/admin/faqs', 'Admin::faqs',['filter' => 'Admin']);
$routes->get('/admin/password', 'Admin::password',['filter' => 'Admin']);



// user pages
$routes->get('/user', 'User::index',['filter' => 'Auth']);
$routes->get('/user/keys', 'User::keys',['filter' => 'Auth']);
$routes->get('/user/credits', 'User::credits',['filter' => 'Auth']);
$routes->get('/user/excel', 'User::excel',['filter' => 'Auth']);
$routes->get('/user/manage_account', 'User::manage_account',['filter' => 'Auth']);
$routes->get('/user/access_keys', 'User::access_keys',['filter' => 'Auth']);
$routes->get('/user/credits', 'User::',['filter' => 'Auth']);
$routes->get('/user/invoices', 'User::invoices',['filter' => 'Auth']);
$routes->get('/user/manage_team', 'User::manage_team',['filter' => 'Auth']);
$routes->get('/user/notifications', 'User::notifications',['filter' => 'Auth']);
